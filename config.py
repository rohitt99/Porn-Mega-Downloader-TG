...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "25830228")  # ⚠️ Required
    API_HASH  = os.environ.get("API_HASH", "a23a5133bddbdab87df3df06ccf63a89") # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "@DENGEROUS_IMP_BOT") # ⚠️ Required
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "6824943579:AAF5GUHPUA5nDZuspI1c24HZr3ywXOMPKI0") # ⚠️ Required
   
    # database config
    DB_URL  = os.environ.get("DB_URL","postgresql://xrlkskby:gobwyeqocauwmdrggqom@alpha.mkdb.sh:5432/rjfvbvce")  # ⚠️ Required
 
    # other configs
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    TG_MAX_SIZE = 2040108421
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://graph.org/file/350c9c541ecf4f2c67070.jpg")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', ''6722550550).split()] # ⚠️ Required
    ...
    FORCE_SUB) else None
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001977784654")) # ⚠️ Required
